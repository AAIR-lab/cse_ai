...
class PID():
    ...
    def do_controller_stuff(self, goal_x, goal_y, goal_z):
        ...
        while distance > 0.04:
            ...
            #print("Current position and rotation errors are: ", (diff_distance, diff_angle))
            ...
            #print("Rushang:", self.move_cmd.angular.z)
            print("Goal rotation: ",goal_z)
            print("current rotation:",rotation)
            print("Current angle error:",current_angle_error)
            print("previous angle_error:",previous_angle_error)
            print("integral_error:",total_angle_error)
            print("diff_error:",diff_angle_error)
            print("Angle Control signal:",self.move_cmd.angular.z)
            print("-------")
    ...
    def publish_velocity(self):
        ...
        print("***** goal rushang:", rounded_x, rounded_y, goal_x, goal_y, goal_z)
        METER_SIZE = 1.0
        NUM_CHECKPOINTS = 1
        ROUND_DIGITS = 0
        ...
        for i in range(1, NUM_CHECKPOINTS + 1):
            if goal_x > rounded_x or goal_y > rounded_y:
            ...
            print("***** checkpoint rushang:", i, goal_x, goal_y, new_goal_x, new_goal_y)
