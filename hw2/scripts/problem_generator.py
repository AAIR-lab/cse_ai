...
def write_pddl(path,object_dict):
    ...
    fhandle.write(hw2_task.get_goal_string(object_dict, book_list,book_loc_list,bins_list,bins_loc_list))
    fhandle.write(")")
    fhandle.close()
...
if __name__ == "__main__":
    ...
    #                         }\
    #             }
    object_dict = pickle.load(open("/home/naman/catkin_ws/src/hw2/object_dict.p","rb"))
