...
; NOTE: This is not the goal condition expected for this task. Read the  task
; instructions.
;
; A sample goal of moving the robot to one of the random book locations.
(:goal (and (Robot_At tbot3 book_2_iloc)))
)
